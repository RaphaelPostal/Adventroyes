...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/assets/css/Header_view.css">
	...
	<header class="header">
		...
		<nav class="menu">
			...
			<ul class="nav">
                ...
                <div id="liens_nav">
				<li class="bot"><a href="<?php echo base_url() ?>/Gamer/NewGamer">Inscription</a></li>
				<li class="bot"><a href="<?php echo base_url() ?>/Gamer">Connexion</a></li>
